...
os.system("CUDA_VISIBLE_DEVICES=0 python train_conditioned.py  --backbone=resnest50 --lr 0.1")
os.system("CUDA_VISIBLE_DEVICES=0 python train_conditioned.py  --backbone=resnest50 --cifar_checkpoint_path experiments/resnest50/conditioned/cifar/checkpoint.pth --fashion_mnist_checkpoint_path experiments/resnest50/conditioned/fashion_mnist/checkpoint.pth --lr 0.01")
os.system("CUDA_VISIBLE_DEVICES=0 python train_conditioned.py  --backbone=resnest50 --cifar_checkpoint_path experiments/resnest50/conditioned/cifar/checkpoint.pth --fashion_mnist_checkpoint_path experiments/resnest50/conditioned/fashion_mnist/checkpoint.pth --lr 0.001")