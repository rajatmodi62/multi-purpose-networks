...
os.system("CUDA_VISIBLE_DEVICES=0 python train_combined.py --backbone=resnet50 --lr 0.1")
os.system("CUDA_VISIBLE_DEVICES=0 python train_combined.py  --backbone=resnet50 --checkpoint_path experiments/resnet50/combined/cifar/checkpoint.pth --lr 0.01")
os.system("CUDA_VISIBLE_DEVICES=0 python train_combined.py  --backbone=resnet50 --checkpoint_path experiments/resnet50/combined/cifar/checkpoint.pth --lr 0.001")
