...
######################## SINGLE TRAINING ###########################################################################################
#######cifar 
os.system("CUDA_VISIBLE_DEVICES=1 python train_single_dataset.py --backbone=resnet50 --lr 0.1")
os.system("CUDA_VISIBLE_DEVICES=1 python train_single_dataset.py --backbone=resnet50 --checkpoint_path experiments/resnet50/cifar/checkpoint.pth --lr 0.01")
os.system("CUDA_VISIBLE_DEVICES=1 python train_single_dataset.py --backbone=resnet50 --checkpoint_path experiments/resnet50/cifar/checkpoint.pth --lr 0.001")
