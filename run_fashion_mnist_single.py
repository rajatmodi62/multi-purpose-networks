...
###fashion-mnist 
os.system("CUDA_VISIBLE_DEVICES=1 python train_single_dataset.py --training_type fashion_mnist --lr 0.1")
os.system("CUDA_VISIBLE_DEVICES=1 python train_single_dataset.py --training_type fashion_mnist --checkpoint_path experiments/fashion_mnist/checkpoint.pth --lr 0.01")
os.system("CUDA_VISIBLE_DEVICES=1 python train_single_dataset.py --training_type fashion_mnist --checkpoint_path experiments/fashion_mnist/checkpoint.pth --lr 0.001")
